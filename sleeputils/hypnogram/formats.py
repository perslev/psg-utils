...
one of the classes in sleeputils.hypnogram.hypnograms) and informing (through its
...
class StartDurationStageFormat(tuple):
    ...
    sleeputils uses this format to pass 'sparse' hypnogram data around. That is,
