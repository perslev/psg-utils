...
import logging
import h5py
from sleeputils.io.psg import extract_psg_data
from sleeputils.io.hypnogram import extract_hyp_data
from sleeputils.io.header import extract_header
from sleeputils.io.channels.utils import get_org_include_exclude_channel_montages
...
def load_hypnogram(file_path, period_length_sec, annotation_dict, sample_rate):
    """
    Returns a sleeputils.hypnogram SparseHypnogram object representation of the
    ...
    Args:
        ...
        sample_rate:        The sample of the original signal - used in rare
                            ...
                            (see sleeputils.hypnogram.utils).
