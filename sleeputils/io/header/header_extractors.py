...
import warnings
import numpy as np
from sleeputils.errors import H5ChannelRootError
from sleeputils.utils import mne_no_log_context
from sleeputils.io.header.header_standardizers import (_standardized_edf_header,
...
def _read_raw_edf_channel_names(edf_file_path):
    ...
    channel_names = [chan for chan in channel_names if "EDF Annot" not in chan]
